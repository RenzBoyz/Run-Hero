...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ᴄʀᴇᴀᴛᴏʀ ʙʏ ʀᴇɴᴢʙᴏʏᴢ⸙","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/Ramdani3.jpg`)},"title": `© ᴄʀᴇᴀᴛᴏʀ ʙʏ ʀᴇɴᴢʙᴏʏᴢ⸙`,"description": "Ramdani Official", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Ramdani Official","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
      ...
      mentions(cptl, x, true)
       ...
       case 'donasi':
        ...
        case 'creator':
               ...
               buttons = [{buttonId: '!hidetag',buttonText:{displayText: 'yσυтυвє'},type:1},{buttonId:'!hidetag',buttonText:{displayText:'ıηsтαgяαм'},type:1}]
...
━━━━━ *INFO BOT* ━━━━━
❏ NAMA : *RenzBoyz*
❏ API : *@6281393526422-@6281393526422*
❏ OWNER : *RenzBoyz*
❏ TAG : *@6281393526422*
...
🎉🎊🥳🎊🎉🥳🎊🎉🥳🎊🎉🥳`
               ...
               buttonsMessage = {
               contentText: `${man}`,
               footerText: '© Creator by RenzBoyz', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
case 'tiktok':
              ...
              imageMsg = (await Ramdani.prepareMessageMedia(fs.readFileSync(`./media/Ramdani3.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/Ramdani3.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Terimakasih', imageMessage: imageMsg,
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              Ramdani.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *© ᴄʀᴇᴀᴛᴏʀ ʙʏ ʀᴇɴᴢʙᴏʏᴢ⸙* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
Ramdani.sendMessage(_.jid, 
			...
			"footerText": '© ᴄʀᴇᴀᴛᴏʀ ʙʏ ʀᴇɴᴢʙᴏʏᴢ⸙',
			"buttons": [
...
//------------------< Menunya Bang:v >-------------------
     case 'info bot':
     reply (`━━━━━ *INFO BOT* ━━━━━
❏ BOT INI MENGGUNAKAN SCRIPT BOT DARI YT RAMDANI OFFICIAL, JIKA INGIN MENDAPATKAN SC INI, TEKAN LINK DI BAWAH INI!!!
❏ LINK YT RAMDANI OFFICIAL : https://youtube.com/channel/UCPhU6uA_3gUaEvyrFZFgJqg
❏ RUN BOT : TERMUX
❏ TIPE SC : JSON
...
└⬣`)
      ...
      case 'qris':      
        qris =`*SCAN QRIS NYA OM, TEEF SEIHKLASNYA🗿*`
               ...
               buttonsMessage = {
               contentText: `${qris}`,
               footerText: '© ᴄʀᴇᴀᴛᴏʀ ʙʏ ʀᴇɴᴢʙᴏʏᴢ⸙', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
//payment                
      case 'dana':
             reply(`DANA : 081393526422`)
             break
           case 'gopay':
             reply(`*Goopay :* 081393526422`)
             break  
         case 'pulsa':
             reply(`*Pulsa :* 081393526422`)
             break              
      case 'infoig':
...
break
  ...
  case 'allmenu':{
					if(MessageType == 'templateLocation'){
						...
						{
							"urlButton": {
								"displayText": "Wangsaf Creator",
								"url": `https://wa.me/qr/YPHXZTRD2G65M1`
								}
								},
								{
									"urlButton": {
